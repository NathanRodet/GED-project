 ...
 */
class getAutorisationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AutorisationRepository' shared autowired service.
     *
     * @return \App\Repository\AutorisationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AutorisationRepository.php';

        return $container->privates['App\\Repository\\AutorisationRepository'] = new \App\Repository\AutorisationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
